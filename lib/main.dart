...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Count Up Demo'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        children:  <Widget>[
          ...
          },color: Colors.yellow,child: const Text("Pause",style: TextStyle(),),),
          MaterialButton(onPressed: (){
            elapsedCountUpController.resume();
          },color: Colors.green,child: const Text("Resume",style: TextStyle(),),),
          MaterialButton(onPressed: (){
            elapsedCountUpController.start();
          },color: Colors.red,child: const Text("Stop",style: TextStyle(),),),
